...
ActiveRecord::Schema.define(version: 20140226030605) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "big_book_chapter_translations", force: :cascade do |t|
  ...
  create_table "big_book_chapters", force: :cascade do |t|
    t.string  "title"
    t.text    "body"
  ...
  create_table "worksheet_translations", force: :cascade do |t|
